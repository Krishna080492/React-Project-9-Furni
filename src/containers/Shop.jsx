...
function Shop() {
  // const product = useSelector((state) => state.product.products); //state.product store.js mathi mdse and .products data mathi mdse
  // or
  const { products } = useSelector((state) => state.product); //destructre method
